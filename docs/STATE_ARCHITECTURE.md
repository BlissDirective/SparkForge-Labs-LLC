...
| `sceneStore` (`useForgeStore` alias) | — | — | 49 | Active 3D scene selection, transition state, game HUD content. **W1-01:** also the Forge Hub slice (`forge.mode`, `frameloop`, portal/Sparky/HoloBubble stubs). Not a new store (TAP §2.5). |
