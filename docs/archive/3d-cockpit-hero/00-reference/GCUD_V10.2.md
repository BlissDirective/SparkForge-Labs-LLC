...
|------|-------|----------------|-------|
| Flagship (Full 3D) | 6 | 20M (20,000,000) | Pet Trainer, Sort Toy Box, Neural Builder, Prompt Lab, Agent Architect, Bias Detective |
| FL-Lite (Immersive 3D) | 9 | 10M (10,000,000) | Data Detective, Robot Vacuum, Camera Quest, Chatbot Builder, Emoji Decoder, Code Blocks, My First AI App, Future Forge, AI or Not? |
