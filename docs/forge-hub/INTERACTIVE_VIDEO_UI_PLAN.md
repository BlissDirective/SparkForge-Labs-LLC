# Interactive video-style UI plan (updated 2026-09-11 evening)
...
## v1 stack
R3F world + Html-on-mesh + named morphs + EscapeFlat for parent/billing.  
Not v1: Pixel Streaming, free-look, Unity WebGL.

## Phases
0 Spec → 1 Room shell → 2 Screen kit → 3 Welcome home → 4 Auth/PlayStage → 5 Content+Sparky → 6 Polish
