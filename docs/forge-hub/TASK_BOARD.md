...
| AP-W0-04 | CLAUDE.md v7 (retire cockpit-as-shell; Forge Hub vision) | 2 | **packet** — [PR #171](https://github.com/BlissDirective/SparkForge-Labs-LLC/pull/171) draft. **Do NOT merge** until owner replies Approve |
...
| W0-04 | Scribe | CLAUDE.md v7 draft as approval packet | **packet** | Tier 2 — AP-W0-04. [PR #171](https://github.com/BlissDirective/SparkForge-Labs-LLC/pull/171) draft; **not done/merged** until owner Approve |
