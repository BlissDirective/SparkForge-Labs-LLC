...
| W0-07 | Scribe + Gatekeeper | PR #164 port list; close after W2 port | **done** (list) | PR #170 — `docs/forge-hub/PR164_PORT_LIST.md`. **Do not close #164 until W2 port.** Gatekeeper+Scribe close then with TAP decision 9 + that list. |
