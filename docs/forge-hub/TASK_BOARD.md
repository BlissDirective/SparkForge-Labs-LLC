...
| W0-08 | Scribe + Director | MOTION_BIBLE.md v1 | **doing** | Director fill-in PR in flight (`grok/director/W0-08-motion-bible`) — DRAFT bodies on Scribe stub [#172](https://github.com/BlissDirective/SparkForge-Labs-LLC/pull/172). Fill-in landing does **not** claim done; Foreman marks **done** after merge |
