...
const GAMES: ArcadeGame[] = [
  { id: 1, name: 'AI Spy', slug: 'ai-spy', lab: 1, labName: 'What IS AI?', tier: 'standard', icon: '🔍', description: 'Spot hidden AI in everyday scenes', ageBands: ['A','B','C'], has3D: false },
  { id: 2, name: 'Time Machine', slug: 'time-machine', lab: 1, labName: 'What IS AI?', tier: 'standard', icon: '⏰', description: 'Place AI milestones on a timeline', ageBands: ['A','B','C'], has3D: false },
  { id: 3, name: 'Human vs Machine', slug: 'human-vs-machine', lab: 1, labName: 'What IS AI?', tier: 'standard', icon: '🤖', description: 'Guess if work was done by human or AI', ageBands: ['A','B','C'], has3D: false },
  ...
  { id: 6, name: 'Treat Trainer', slug: 'treat-trainer', lab: 2, labName: 'AI Assistants', tier: 'standard', icon: '🦴', description: 'Teach an AI pet using rewards and penalties', ageBands: ['A','B','C'], has3D: false },
  ...
  { id: 9, name: 'Neuron Relay', slug: 'neuron-relay', lab: 3, labName: 'How AI Learns', tier: 'standard', icon: '⚡', description: 'Pass signals through a neural network relay', ageBands: ['A','B','C'], has3D: false },
  { id: 10, name: 'Pixel Investigator', slug: 'pixel-investigator', lab: 3, labName: 'How AI Learns', tier: 'standard', icon: '🖼️', description: 'Explore how AI sees and processes images', ageBands: ['B','C'], has3D: false },
  ...
  { id: 12, name: 'Word Predictor', slug: 'word-predictor', lab: 4, labName: 'AI & Language', tier: 'standard', icon: '📝', description: 'Predict the next word like a language model', ageBands: ['A','B','C'], has3D: false },
  { id: 13, name: 'Token Chopper', slug: 'token-chopper', lab: 4, labName: 'AI & Language', tier: 'standard', icon: '✂️', description: 'Break text into tokens like an AI tokenizer', ageBands: ['B','C'], has3D: false },
  { id: 14, name: 'AI Art Detective', slug: 'ai-art-detective', lab: 4, labName: 'AI & Language', tier: 'standard', icon: '🎨', description: 'Determine if artwork was made by AI or human', ageBands: ['A','B','C'], has3D: false },
  ...
  { id: 17, name: 'Tool Picker', slug: 'tool-picker', lab: 6, labName: 'AI & Society', tier: 'standard', icon: '🔧', description: 'Match the right AI tool to each task', ageBands: ['A','B','C'], has3D: false },
  ...
  { id: 19, name: 'Data Shield', slug: 'data-shield', lab: 6, labName: 'AI & Society', tier: 'standard', icon: '🛡️', description: 'Protect personal data from AI misuse', ageBands: ['A','B','C'], has3D: false },
  { id: 20, name: 'Real or Fake', slug: 'real-or-fake', lab: 6, labName: 'AI & Society', tier: 'standard', icon: '🔮', description: 'Spot AI-generated content vs real content', ageBands: ['A','B','C'], has3D: false },
  { id: 21, name: 'Ethics Courtroom', slug: 'ethics-courtroom', lab: 6, labName: 'AI & Society', tier: 'standard', icon: '⚖️', description: 'Judge AI ethics cases as a courtroom judge', ageBands: ['B','C'], has3D: false },
  ...
  { id: 23, name: 'Fool the AI', slug: 'fool-the-ai', lab: 7, labName: 'Computer Vision', tier: 'standard', icon: '🎭', description: 'Create adversarial examples to trick AI', ageBands: ['B','C'], has3D: false },
  { id: 24, name: 'Build Classifier', slug: 'build-classifier', lab: 7, labName: 'Computer Vision', tier: 'standard', icon: '📊', description: 'Build an image classifier step by step', ageBands: ['B','C'], has3D: false },
  { id: 25, name: 'Prediction Market', slug: 'prediction-market', lab: 7, labName: 'Computer Vision', tier: 'standard', icon: '📈', description: 'Predict outcomes and calibrate confidence', ageBands: ['B','C'], has3D: false },
  { id: 26, name: 'Sentiment Scanner', slug: 'sentiment-scanner', lab: 8, labName: 'AI Communication', tier: 'standard', icon: '😊', description: 'Analyze the sentiment of text like an AI', ageBands: ['A','B','C'], has3D: false },
  ...
  { id: 28, name: 'Lost in Translation', slug: 'lost-in-translation', lab: 8, labName: 'AI Communication', tier: 'standard', icon: '🌍', description: 'See how AI translation can go wrong', ageBands: ['A','B','C'], has3D: false },
  ...
  { id: 31, name: 'Career Explorer', slug: 'career-explorer', lab: 9, labName: 'Building with AI', tier: 'standard', icon: '🎯', description: 'Discover AI-related career paths', ageBands: ['B','C'], has3D: false },
  { id: 32, name: 'API Explorer', slug: 'api-explorer', lab: 9, labName: 'Building with AI', tier: 'standard', icon: '🔌', description: 'Learn how APIs connect AI services', ageBands: ['C'], has3D: false },
