...
const GAMES: { slug: string; archetype: 'SORT' | 'REVEAL' | 'CONNECT' | 'REACT' | 'PHASER' | 'DOM' }[] = [
  ...
  { slug: 'ai-art-detective', archetype: 'DOM' },
  { slug: 'camera-quest', archetype: 'DOM' },
  { slug: 'fool-the-ai', archetype: 'DOM' },
  { slug: 'build-classifier', archetype: 'SORT' },
  { slug: 'prediction-market', archetype: 'DOM' },
  { slug: 'sentiment-scanner', archetype: 'DOM' },
  { slug: 'emoji-decoder', archetype: 'DOM' },
  ...
  { slug: 'pixel-investigator', archetype: 'DOM' },
  ...
  { slug: 'bias-detective', archetype: 'DOM' },
];
